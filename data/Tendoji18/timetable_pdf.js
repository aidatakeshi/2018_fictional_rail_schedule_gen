global.timetable_pdf = {
    ...
    train_types_overwrite: {
        ...
        "HOR": {color: {bg: "#FF00AA"}},
        "SEE": {color: {bg: "#FF00AA"}},
        "COR": {color: {bg: "#D38D00", text: "blue", specialTextColor: true}},
        "SPR": {color: {bg: "#D38D00", text: "red", specialTextColor: true}},
        "SSE$": {color: {box: "#FF9"}, name: "区間準急（東青山通過）", name_eng: "S.S.Exp. (skips Aoyama East)"},
        "SEX$": {color: {box: "#FF9"}, name: "準急（砂田通過）", name_eng: "Semi-Exp. (skips Sunada)"},
        "EXP$": {color: {box: "#FF9"}, name: "急行（砂田通過）", name_eng: "Express (skips Sunada)"},
        "LOA": {color: {bg: "#0080FF", text: "#333", specialTextColor: true}, name: "準各停（パータンA）", name_eng: "Local (skip-stop pattern A)"},
        "LOB": {color: {bg: "#00C46B", text: "#333", specialTextColor: true}, name: "準各停（パータンB）", name_eng: "Local (skip-stop pattern B)"},
        "RAP": {color: {bg: "#D38D00"}},
        "REX": {color: {bg: "#933B00"}},
        "LEX": {color: {bg: "#AF003F"}},
        "AEL": {color: {text: "#FFF", specialTextColor: true}, name: "AEライナー（直行）", name_eng: "AE Liner (direct)"},
        "ALR": {color: {text: "#FC6", specialTextColor: true}, name: "AEライナー（藍田停車）", name_eng: "AE Liner (stops in Aida)"},
