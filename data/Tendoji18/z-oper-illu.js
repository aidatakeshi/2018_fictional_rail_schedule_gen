	...
	global.oper_illu = {
		...
		"main": {
			...
			train_runs: [
				...
				//Rapid
				{from: "R01", to: "S99", icons: {"10000": 38, "11000": 15}},
			...
			stations: {
				...
				"510": [{tracks: ["1"], location: [690, 1080], shift: [0, +30]}, {tracks: ["2"], location: [690, 1080], shift: [0, -30]}],
				"509": [{tracks: ["1"], location: [780, 1080], shift: [0, +90]}, {tracks: ["2"], location: [780, 1080], shift: [0, -90]}],
				"508": [{tracks: ["1"], location: [870, 1080], shift: [0, +30]}, {tracks: ["2"], location: [870, 1080], shift: [0, -30]}],
				"507": [
					{tracks: ["1"], location: [960, 1080], shift: [0, +60]},
					{tracks: ["2"], location: [960, 1080], shift: [0, 0]},
					{tracks: ["3"], location: [960, 1080], shift: [0, -60]},
				],
				"506": [{tracks: ["1"], location: [1050, 1080], shift: [0, +30]}, {tracks: ["2"], location: [1050, 1080], shift: [0, -30]}],
				"505": [{tracks: ["1"], location: [1140, 1080], shift: [0, +90]}, {tracks: ["2"], location: [1140, 1080], shift: [0, -90]}],
				"504": [{tracks: ["1"], location: [1230, 1080], shift: [0, +30]}, {tracks: ["2"], location: [1230, 1080], shift: [0, -30]}],
				"503": [
					{tracks: ["1"], location: [1320, 1080], shift: [0, +60]},
					{tracks: ["2"], location: [1320, 1080], shift: [0, 0]},
					{tracks: ["3"], location: [1320, 1080], shift: [0, -60]},
				],
				"502": [{tracks: ["1"], location: [1410, 1080], shift: [0, +30]}, {tracks: ["2"], location: [1410, 1080], shift: [0, -30]}],
				"501": [
					{tracks: ["3"], location: [1500, 1080], shift: [0, +90]}, {tracks: ["4"], location: [1500, 1080], shift: [0, +30]},
					{tracks: ["5"], location: [1500, 1080], shift: [0, -30]}, {tracks: ["6"], location: [1500, 1080], shift: [0, -90]},
				],
				"902": [{tracks: ["1"], location: [1590, 1080], shift: [0, +30]}, {tracks: ["2"], location: [1590, 1080], shift: [0, -30]}],
				"903": [
					{tracks: ["1"], location: [1680, 1080], shift: [0, +60]},
					{tracks: ["2"], location: [1680, 1080], shift: [0, 0]},
					{tracks: ["3"], location: [1680, 1080], shift: [0, -60]},
				],
				"904": [{tracks: ["1"], location: [1830, 990], shift: [+30, 0]}, {tracks: ["2"], location: [1830, 990], shift: [-30, 0]}],
				"905": [{tracks: ["1"], location: [1830, 900], shift: [+90, 0]}, {tracks: ["2"], location: [1830, 900], shift: [-90, 0]}],
				"906": [{tracks: ["1"], location: [1830, 810], shift: [+30, 0]}, {tracks: ["2"], location: [1830, 810], shift: [-30, 0]}],
				"907": [
					{tracks: ["5"], location: [1830, 720], shift: [+60, 0]},
					{tracks: ["7"], location: [1830, 720], shift: [0, 0]},
					{tracks: ["6"], location: [1830, 720], shift: [-60, 0]},
				],
				"908": [{tracks: ["1"], location: [1830, 630], shift: [+30, 0]}, {tracks: ["2"], location: [1830, 630], shift: [-30, 0]}],
				"909": [{tracks: ["1"], location: [1830, 540], shift: [+90, 0]}, {tracks: ["2"], location: [1830, 540], shift: [-90, 0]}],
				"910": [{tracks: ["1"], location: [1830, 450], shift: [+30, 0]}, {tracks: ["2"], location: [1830, 450], shift: [-30, 0]}],
				"911": [
					{tracks: ["5"], location: [1680, 360], shift: [0, -60]},
					{tracks: ["6"], location: [1680, 360], shift: [0, 0]},
					{tracks: ["7"], location: [1680, 360], shift: [0, +60]},
				],
				"912": [{tracks: ["1"], location: [1560, 360], shift: [0, -30]}, {tracks: ["2"], location: [1560, 360], shift: [0, +30]}],
				"913": [{tracks: ["1"], location: [1440, 360], shift: [0, -90]}, {tracks: ["2"], location: [1440, 360], shift: [0, +90]}],
				"914": [{tracks: ["1"], location: [1320, 360], shift: [0, -30]}, {tracks: ["2"], location: [1320, 360], shift: [0, +30]}],
				"915": [
					{tracks: ["1"], location: [1200, 360], shift: [0, -60]},
					{tracks: ["2"], location: [1200, 360], shift: [0, 0]},
					{tracks: ["3"], location: [1200, 360], shift: [0, +60]},
				],
				"916": [
					{tracks: ["1","2"], location: [1080, 360], shift: [0, -30], upbound: true},
					{tracks: ["1","2"], location: [1080, 360], shift: [0, +30], upbound: false},
				],
			},
			...
			section_points: [
				...
				{from: "916", from_tracks: ["1","2"], to: "915", to_tracks: ["1","2"], points: [[1140, 330, null]], showDot: true},
				{from: "915", from_tracks: ["1","2"], to: "914", to_tracks: ["1"], points: [[1260, 330, null]], showDot: true},
				{from: "914", from_tracks: ["2"], to: "915", to_tracks: ["3","2"], points: [[1260, 390, null]], showDot: true},
				{from: "915", from_tracks: ["3","2"], to: "916", to_tracks: ["1","2"], points: [[1140, 390, null]], showDot: true},
				{from: "914", from_tracks: ["1"], to: "913", to_tracks: ["1"], points: [[1380, 330, null]], showDot: true},
				{from: "913", from_tracks: ["1"], to: "912", to_tracks: ["1"], points: [[1500, 330, null]], showDot: true},
				{from: "912", from_tracks: ["2"], to: "913", to_tracks: ["2"], points: [[1500, 390, null]], showDot: true},
				{from: "913", from_tracks: ["2"], to: "914", to_tracks: ["2"], points: [[1380, 390, null]], showDot: true},
				{from: "912", from_tracks: ["1"], to: "911", to_tracks: ["5","6"], points: [[1620, 330, null]], showDot: true},
				{from: "911", from_tracks: ["7","6"], to: "912", to_tracks: ["2"], points: [[1620, 390, null]], showDot: true},
				{from: "904", from_tracks: ["1"], to: "903", to_tracks: ["1","2"], points: [[1860, 1020+m4, null], [1770+m4, 1110, null], [1740, 1110, null]], showDot: true},
				{from: "903", from_tracks: ["3","2"], to: "904", to_tracks: ["2"], points: [[1740, 1050, null], [1770-m4, 1050, null], [1800, 1020-m4, null]], showDot: true},
				{from: "911", from_tracks: ["5","6"], to: "910", to_tracks: ["1"], points: [[1740, 330, null], [1770+m4, 330, null], [1860, 420-m4, null]], showDot: true},
				{from: "910", from_tracks: ["2"], to: "911", to_tracks: ["7","6"], points: [[1800, 420+m4, null], [1770-m4, 390, null], [1740, 390, null]], showDot: true},
				//Tendouji Line (Mugikyu)
				{from: "510", from_tracks: ["1"], to: "112", to_tracks: ["2"], points: [[630+m4, 1110, null], [600, 1140+m4, null]], showDot: true},
				{from: "112", from_tracks: ["3"], to: "510", to_tracks: ["2"], points: [[540, 1140-m4, null], [630-m4, 1050, null]], showDot: true},
				...
				{from: "112", from_tracks: ["2"], to: "113", to_tracks: ["2"],points: [[600, 1230+m4, null], [540+m4, 1290, null], [420+m4, 1290, null], [300, 1410+m4, null]], zIndex: -2, showDot: true},
				{from: "113", from_tracks: ["5"], to: "112", to_tracks: ["3"],points: [[240, 1410-m4, null], [420-m4, 1230, null], [540-m4, 1230, null], [540, 1230-m4, null]], zIndex: -2, showDot: true},
				{from: "112", from_tracks: ["2"], to: "113", to_tracks: ["1"],points: [[600, 1230+m4, null], [540+m4, 1290, null], [420+m4, 1290, null], [360, 1350+m4, null]], zIndex: -2, showDot: true},
				{from: "113", from_tracks: ["6"], to: "112", to_tracks: ["3"],points: [[180, 1470-m4, null], [420-m4, 1230, null], [540-m4, 1230, null], [540, 1230-m4, null]], zIndex: -2, showDot: true},
				//Aoyama Line
