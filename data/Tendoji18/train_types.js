...
global.train_types = {
	...
	"LOB": {
		name: "準各停", name_short: "準各", name_eng: "Local", name_eng_short: "Local", priority: 2,
		name_chi: "准各停", name_chi_short: "准各", name_kor: "준각정", name_kor_short: "각정",
		color: {bg: "#A6FFDF", text: "#000"},
	},
	"LOA": {
		name: "準各停", name_short: "準各", name_eng: "Local", name_eng_short: "Local", priority: 3,
		name_chi: "准各停", name_chi_short: "准各", name_kor: "준각정", name_kor_short: "각정",
		color: {bg: "#A6CAFF", text: "#000"},
	},
	"LCL": {
		name: "普通", name_short: "普通", name_eng: "Local", name_eng_short: "Local", priority: 10,
		name_chi: "普通", name_chi_short: "普通", name_kor: "공통", name_kor_short: "공통",
		color: {bg: "#cccccc", text: "#000"},
	},
	"SER": {
		name: "区間快速", name_short: "区快", name_eng: "Sectional Rapid", name_eng_short: "S.Rapid", priority: 11,
		name_chi: "区间快速", name_chi_short: "区快", name_kor: "구간쾌속", name_kor_short: "구쾌",
		color: {bg: "#9E00F2", text: "#FFF"},
	},
	"SSR": {
		name: "区間特快", name_short: "区特", name_eng: "Sectional Special Rapid", name_eng_short: "S.S.Rapid", priority: 12,
		name_chi: "区间特快", name_chi_short: "区特", name_kor: "구간특쾌", name_kor_short: "구특",
		color: {bg: "#5B00A3", text: "#FFF"},
	},
	"HOR": {
	...
	"SSE$": {
		name: "区間準急", name_short: "区準", name_eng: "Sectional Semi-Express", name_eng_short: "S.S.Exp.", priority: 14 - 0.1,
		name_chi: "区间准急", name_chi_short: "区准", name_kor: "구간준급", name_kor_short: "구준",
		color: {bg: "#006BE0", text: "#FF0"},
	},
	"SEX": {
	...
	"SEX$": {
		name: "準急", name_short: "準急", name_eng: "Semi-Express", name_eng_short: "S.Exp.", priority: 15 - 0.1,
		name_chi: "准急", name_chi_short: "准急", name_kor: "준급", name_kor_short: "준급",
		color: {bg: "#00C12D", text: "#FF0"},
	},
	"SEE": {
	...
	"EXP$": {
		name: "急行", name_short: "急行", name_eng: "Express", name_eng_short: "Express", priority: 19 - 0.1,
		name_chi: "急行", name_chi_short: "急行", name_kor: "급행", name_kor_short: "급행",
		color: {bg: "#FF6700", text: "#FF0"},
	},
	"REX": {
