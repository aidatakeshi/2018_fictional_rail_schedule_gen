...
global.train_arrangements["AA"] = {
	...
	tripNo: global.standardFn.tripNo.bind({initial: "E", baseNum: 60, digits: 2, minsShift: {"01": 0, "02": 7}}),
	runNo: global.standardFn.runNo.bind({initial: "E", baseNum: 60, digits: 2}),
...
global.train_arrangements["AB"] = {
	...
	tripNo: global.standardFn.tripNo.bind({
		initial: "E", baseNum: 60, digits: 2, minsShift: {"01": 0, "02": 7},
		runOrderModifier: CLE_RunOrderModifier
	}),
	runNo: global.standardFn.runNo.bind({
		initial: "E", baseNum: 60, digits: 2,
		runOrderModifier: CLE_RunOrderModifier
	}),
...
global.train_arrangements["AC"] = {
	...
	tripNo: global.standardFn.tripNo.bind({
		initial: "F", baseNum: 60, digits: 2, minsShift: {"01": 0, "02": 7},
		runOrderModifier: CLE_RunOrderModifier
	}),
	runNo: global.standardFn.runNo.bind({
		initial: "F", baseNum: 60, digits: 2,
		runOrderModifier: CLE_RunOrderModifier
	}),
	refNo: global.standardFn.refNo.bind({baseNum: 700, digits: 3, numShift1: 0, numShift2: 0}),
	patterns: {
