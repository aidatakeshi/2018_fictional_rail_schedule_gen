...
global.lines = {
	"MK": {
		...
		types: ["AEL", "CLE", "RLE", "LEX", "SLE", "REX", "EXP", "SPR", "RAP", "COR", "SEX", "SSE", "SER", "AOC", "AOE"],
		tracks: {
			overall: ["A", "B", "C"],
			default: "A",
			sections: [
		...
		stations: [
			...
			{id: "128", mileage: 31.1, types: ["SSE", "SER"]},
			{id: "129", mileage: 32.2, types: ["SSE", "SER"]},
			{id: "130", mileage: 33.3, types: ["SSE", "SER"]},
			{id: "131", mileage: 34.5, types: ["REX", "EXP", "SPR", "RAP", "COR", "SEX", "SSE", "SER"], showArrival: true},
			{id: "132", mileage: 35.6, types: ["SEX", "SSE"]},
			{id: "133", mileage: 36.8, types: ["SEX", "SSE"]},
			{id: "134", mileage: 38.5, types: ["SEX", "SSE"]},
			{id: "135", mileage: 40.1, types: ["EXP", "SPR", "RAP", "COR", "SEX", "SSE"]},
			{id: "136", mileage: 41.3, types: ["SEX", "SSE"]},
			{id: "137", mileage: 42.4, types: ["SEX", "SSE"]},
			{id: "138", mileage: 43.7, types: ["SEX", "SSE"]},
	...
	"TE": {
		...
		types: ["RAP", "COR", "SER", "HOR"],
		stations: [
			{id: "501", mileage: 0.0, types: ["RAP", "COR", "SER", "HOR"]},
			{id: "502", mileage: 0.9, types: []},
			{id: "503", mileage: 2.0, types: ["RAP", "COR", "SER", "HOR"]},
			{id: "504", mileage: 3.8, types: ["HOR"]},
			{id: "505", mileage: 4.8, types: ["HOR"], showArrival: true},
			{id: "506", mileage: 5.8, types: ["HOR"]},
			{id: "507", mileage: 6.7, types: ["RAP", "COR", "SER"]},
	...
	"TS": {
		...
		stations: [
			...
			{id: "915", mileage: 2.8, types: ["RAP", "COR", "SER", "HOR"]},
			{id: "914", mileage: 4.8, types: ["SER", "HOR"]},
			{id: "913", mileage: 6.7, types: ["SER", "HOR"], showArrival: true},
			{id: "912", mileage: 8.4, types: ["SER", "HOR"]},
			{id: "911", mileage: 10.0, types: ["RAP", "COR", "SER", "HOR"]},
			{id: "910", mileage: 10.8, types: []},
			{id: "909", mileage: 12.0, types: [], showArrival: true},
			{id: "908", mileage: 13.1, types: []},
			{id: "907", mileage: 14.3, types: ["RAP", "COR", "SER", "HOR"]},
			{id: "906", mileage: 15.7, types: []},
			{id: "905", mileage: 17.0, types: [], showArrival: true},
			{id: "904", mileage: 18.2, types: []},
			{id: "903", mileage: 19.4, types: ["RAP", "COR", "SER", "HOR"]},
			{id: "902", mileage: 20.8, types: []},
			{id: "501", mileage: 22.0, types: ["RAP", "COR", "SER", "HOR"]},
		],
	},
	"AY": {
